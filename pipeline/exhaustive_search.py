"""Bounded-memory, resumable scoring of the indexed catalyst population."""
...
from pipeline.discovery import candidate_id, canonicalize_genome, discovery_region
from pipeline.indexed_space import TOTAL_SIZE, candidate_at, is_physically_admissible
